                ...
                return (
                    <div className="h-full overflow-y-auto p-6 border-r bg-white shadow-lg relative z-10">
                        ...
                        <div className="space-y-4">
                            ...
                            <button type="button" className="btn btn-primary w-full py-3 font-bold shadow-sm" onClick={handleSubmitShipment}>
                                Kaydet ve Gönder
                            </button>
                                    ...
                                    <div className="mt-3 flex gap-2">
                                        <button
                                            onClick={() => {
                                                ...
                                                // Scroll to top
                                                document.querySelector('.h-full').scrollTop = 0;
                                            }}
                                            className="flex-1 btn bg-slate-100 text-slate-600 text-xs hover:bg-slate-200"
                                        >
                                            Düzenle
                                        </button>
                                        <button
                                            ...
                                            className="flex-1 btn bg-red-50 text-red-600 text-xs hover:bg-red-100"
                                        >
                                            Sil
                                        </button>
                                    </div>
