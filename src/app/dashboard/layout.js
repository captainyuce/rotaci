    ...
    return (
        <div className="relative h-screen w-screen overflow-hidden">
            ...
            <button
                ...
                className="fixed top-4 left-4 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm p-3 rounded-xl shadow-lg hover:shadow-xl transition-all border border-slate-200 dark:border-slate-800"
            >
                {menuOpen ? <X size={24} className="text-slate-700 dark:text-white" /> : <Menu size={24} className="text-slate-700 dark:text-white" />}
            </button>

            {/* Notification Bell & Chat */}
            <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
                <div id="header-chat" className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm p-2 rounded-xl shadow-lg hover:shadow-xl transition-all border border-slate-200 dark:border-slate-800">
                    <ChatBox />
                </div>
                <div id="header-notification" className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm p-2 rounded-xl shadow-lg hover:shadow-xl transition-all border border-slate-200 dark:border-slate-800">
                    <NotificationBell />
                </div>
            </div>
            ...
            {/* Sliding Menu */}
            {menuOpen && (
                <div className="fixed left-4 top-20 w-64 md:w-80 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 z-40 max-h-[calc(100vh-104px)] flex flex-col">
                    <div className="p-4 md:p-6 border-b border-slate-200 dark:border-slate-800">
                        <h2 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white">Rota Optimizasyon</h2>
                        <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400">Yönetim Paneli</p>
                    ...
                    <div className="flex flex-col items-center gap-4 py-4 border-t border-slate-100 dark:border-slate-800">
                        <button
                            onClick={() => {
                                setMenuOpen(false)
                                startTutorial()
                        ...
                        <div className="text-[10px] font-bold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded border border-green-200 dark:border-green-800">
                            v1.3 - SYSTEM READY
                        </div>
                    </div>
                </div>
